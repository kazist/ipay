...
namespace Ipay\Payments\Ipay\Code\Models;
...
class IpayModel extends PaymentsModel {
    ...
    private function getIpayParams($payment_id) {
        ...
        $factory->saveRecordByEntity('#__ipay_payments_ipay', $posted_data, array('fpi.txncd=:txncd'), array('txncd' => $posted_data['txncd']));
