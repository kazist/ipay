...
namespace Ipay\Payments\Ipay\Code\Tables;
 ...
 * Ipay
 *
 * @ORM\Table(name="ipay_payments_ipay", indexes={@ORM\Index(name="payment_id_index", columns={"payment_id"}), @ORM\Index(name="created_by_index", columns={"created_by"}), @ORM\Index(name="modified_by_index", columns={"modified_by"})})
 * @ORM\Entity
